document.querySelector(".pagination > div:nth-child(2)").addEventListener('click', () => {
    ...
    document.querySelector("#us figure").innerHTML = "<img src='img/team/hanako_flower.jpg' alt=''>"
})
...
document.querySelector(".pagination > div:nth-child(1)").addEventListener('click', () => {
    ...
    document.querySelector("#us figure").innerHTML = "<img src='img/team/toshiaki_portrait.jpg' alt=''>"
})
